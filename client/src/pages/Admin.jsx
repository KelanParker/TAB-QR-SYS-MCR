    ...
    <div className="min-h-screen bg-gray-100 py-10">
      <div className="max-w-6xl mx-auto">
            ...
            <tbody>
              {employees.map((employee) => (
                <tr key={employee.id} className="border-b">
                  <td className="py-4">{employee.employee_no}</td>
        ...
        <div className="bg-white rounded-xl shadow p-6">
          <h2 className="text-2xl font-bold mb-6">Tablets</h2>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b">
                <th className="text-left py-3">Tablet Code</th>
            ...
            <tbody>
              {tablets.map((tablet) => (
                <tr key={tablet.id} className="border-b">
                  <td className="py-4">{tablet.tablet_code}</td>

                  <td>{tablet.display_name}</td>
